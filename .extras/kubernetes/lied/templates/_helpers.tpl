...
*/}}
{{- define "lied.labels" -}}
helm.sh/chart: {{ include "lied.chart" . }}
{{ include "lied.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "lied.selectorLabels" -}}
app: {{ include "lied.name" . }}
app.kubernetes.io/name: {{ include "lied.name" . }}
