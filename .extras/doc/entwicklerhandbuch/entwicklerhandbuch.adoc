...
."LiedGetController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,LiedGetController,svg]
----
include::LiedGetController.plantuml[]
----

Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Donec
sollicitudin molestie malesuada.

."LiedWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,LiedGetController,svg]
----
include::LiedWriteController.plantuml[]
----
...
.LiedQueryResolver für Lesezugriffe an der GraphQL-Schnittstelle
[plantuml,LiedQueryResolver,svg]
----
include::LiedQueryResolver.plantuml[]
----

Donec sollicitudin molestie malesuada. Praesent sapien massa, convallis a
pellentesque nec, egestas non nisi.

.LiedMutationResolver für Schreibzugriffe an der GraphQL-Schnittstelle
[plantuml,LiedMutationResolver,svg]
----
include::LiedMutationResolver.plantuml[]
----
...
."LiedReadService" im Anwendungskern
[plantuml,LiedReadService,svg]
----
include::LiedReadService.plantuml[]
----

Pellentesque in ipsum id orci porta dapibus. Donec rutrum congue leo eget
malesuada.

."LiedWriteService" im Anwendungskern
[plantuml,LiedWriteService,svg]
----
include::LiedWriteService.plantuml[]
----
